...
//         {items.map((item, idx) => (
//           <li
//             className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-zinc-700 px-8 py-6 md:w-[450px] dark:bg-[linear-gradient(180deg, var(--zinc-800), var(--zinc-900))]  bg-[linear-gradient(180deg, var(--zinc-100), var(--zinc-200))] "
...
//                   <span className=" text-md leading-[1.6] font-bold text-rose-400">
//                     {item.name}
//                   </span>
