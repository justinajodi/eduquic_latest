                ...
                {(provided) => (
                  <div
                    className={cn(
                      ...
                      chapter.isPublished && "bg-rose-100 border-rose-200 text-rose-700 dark:text-rose-500"
                    )}
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        chapter.isPublished && "border-r-rose-200 hover:bg-rose-200"
                      )}
                    ...
                    <div className="ml-auto pr-2 flex items-center gap-x-2">
                      ...
                      <Badge
                        className={cn(
                          "bg-zinc-500",
                          chapter.isPublished && "bg-rose-700"
                        )}
                      >
